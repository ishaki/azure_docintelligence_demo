...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (!fileInput || !selectFilesBtn || !uploadArea || !filesList || !uploadBtn || !clearBtn) {
    ...
    // Make uploadArea clickable, but exclude button clicks
    uploadArea.addEventListener('click', (e) => {
        // Don't trigger if clicking on the button or inside the button
